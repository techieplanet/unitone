    ...
    <ul class="sidebar-menu">
      ...
      <!--CUSTOMER-->
                  ...
                  <li class="treeview">
                      ...
                      <ul class="treeview-menu">
                        <li><a href="${pageContext.request.contextPath}/Project">Agent</a></li>
                        <li><a href="${pageContext.request.contextPath}/Project?action=new">Customer</a></li>
                      </ul>
                  </li>
                  ...
                  <!--ANNOUNCEMENT-->
                  <li class="treeview">
                      <a href="#"><i class="fa fa-microphone"></i><span>Feedback</span><i class="fa fa-angle-left pull-right"></i></a>
                      <ul class="treeview-menu">
                        <li><a href="${pageContext.request.contextPath}/Project">Agent</a></li>
                        <li><a href="${pageContext.request.contextPath}/Project?action=new">Customer</a></li>
                      </ul>
