                  ...
                  <c:if test="${sessionScope.user.getSystemUserTypeId() == 2}">
                        <li class="treeview <c:out  value='${sideNav eq "Agent" ? "active":""}' />">
                          ...
                          <ul class="treeview-menu">
                            ...
                            <li><a href="${pageContext.request.contextPath}/Agent?action=debit_history" <c:if test="${sideNavAction eq 'debit_history' && sideNav eq 'Agent'}"> <c:out value='style=color:#fff' /></c:if> >Debit History</a></li>
