...
<div class="stepwizard">
    <div class="stepwizard-row">
        <div class="stepwizard-step">
            <button type="button" id="process-step-1" class="btn btn-circle btn-primary"  onclick="return showCustomerReg()">1</button>
            <p>Agent Form</p>
        </div>
        <div class="stepwizard-step">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group" style="padding-right:10px !important;padding-left:10px !important;">
                                                            ...
                                                            <input type="number" class="form-control" id="agentKinPhone" name="agentKinPhone" placeholder="Enter Kin Phone Number"  
                                                    ...
                                                    <div class="col-md-6 " >
                                                        <div class="row" >
                                                            <div class="form-group" style="padding-left:25px !important;">
                                                                <label for="agentKinRelationship" style="">Next of Kin Relationship</label>
                                                                <input type="text" class="form-control" id="agentKinRelationship" name="agentKinRelationship" placeholder="Relationship with Next of Kin" style="  width:100%;"

                                                                           value=<c:if test="${fn:length(errors) > 0 }">"${param.agentKinRelationship}"</c:if><c:if test="${fn:length(errors) <= 0 }">"${agent.kinRelationship}"</c:if> "/><br/>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group" >
                                                                <label for="agentKinPhoto" ">Next Of Kin PassPort</label>
                                                                <input    class="form-control" type="file" name="agentKinPhoto" accept="image/gif, image/jpeg, image/png , image/bmp" id="agentKinPhoto" >
                                                            </div>
                                                        </div>  
                                                        <div class="col-md-6">
                                                            <div class="form-group" >
                                                                <label for="utilityBill">Utility Bill</label>
                                                                <input    class="form-control" type="file" name="utilityBill" accept="image/gif, image/jpeg, image/png, image/bmp" id="utilityBill" >
                                                            </div>    
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-group" >
                                                                <label for="agentPhotoID">Means Of ID (ID card,etc)</label>
                                                                <input    class="form-control" type="file" name="agentPhotoID" accept="image/gif, image/jpeg, image/png , image/bmp" id="agentPhotoID" >
                                                            </div>
                                                        </div>      
...
<script>
    ...
    var formFieldStage2 = [["agentPhoto", "", "Agent PassPort"],
    ...
    function validateAgentForm(stage) {
        ...
        if (stage === 1)
        {
            ...
            $.ajax({
                url:"${pageContext.request.contextPath}/Agent?action=email_validation",
                method: 'GET',
