                                    ...
                                    <table class="table table-bordered table-striped table-hover">
                                        ...
                                        <c:forEach items="${documents}" var="document">
                                            <tr>
                                                ...
                                                <td ><a href="${documentDir}${document.path}" target="_blank" ><img src="${documentDir}${document.path}" class="img img-responsive img-thumbnail" style="max-width: 100px;max-height: 100px; overflow-y: auto"/></a>
                                                </td>
                                            </tr>
