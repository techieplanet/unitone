                      ...
                      <div class="col-md-3">
                        <div class="thumbnail">
                          ...
                          <div class="caption text-center">
                            ...
                            <c:choose>
                            <c:when test="${unit.getMaxPaymentDuration() != 0}"><span>Payment Duration : <b>${unit.getMaxPaymentDuration()} Month</b> </span><br/></c:when>
                            <c:otherwise><span>Payment Duration : <b>Outright</b> </span><br/></c:otherwise>
                             </c:choose>
