                ...
                <div class="box-header with-border">
                  <div class="row">  
                      ...
                      <div class="col-md-4 text-right">
                          ...
                          <select id="customerFilter" onchange="agentMessage.filter()">
        ...
        <div class="tab-content">    
          ...
          <div class="box box-default" >
              ...
              <div class="box-body">
                  ...
                  <form action="${pageContext.request.contextPath}/Message?action=agent_email" method="POST">
          ...
          <div class="box box-default">
              ...
              <div class="box-body">
                  ...
                  <form action="${pageContext.request.contextPath}/Message?action=agent_sms" method="POST">
            ...
            filter : function(){
                ...
                $.ajax({
                    ...
                    success : function(data){
                        ...
                        console.log(data);
                        agentMessage.redrawTable(JSON.parse(data))
                        table.draw();
                    },
